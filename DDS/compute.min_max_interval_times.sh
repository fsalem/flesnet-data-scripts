...
CMD_F1="$LABEL 'Difference between min and max start times of intervals of Compute node#${array[1]} in ${array[0]} [$INPUT_COUNT INs, $COMPUTE_COUNT CNs, $INPUT_BW GB/s] [$DATE]'; plot "
