...
LABEL=" set xlabel 'Timeslice no.' font 'Helvetica,20' offset 0,-5,0; 
	set ylabel 'Duration [ms]' font 'Helvetica,20';
	...
	#set lmargin 18;
	#set rmargin 7;"
CMD="$LABEL set title 'The Duration to Complete a timeslice'; plot "
#CMD="$LABEL; plot "
...
CMD="$CMD '$FILE_NAME1' using (\$1-(floor(\$1/1)*1)==0?\$1:1/0):(\$2/1000) with points title 'New', '$FILE_NAME2' using (\$1-(floor(\$1/1)*1)==0?\$1:1/0):(\$2/1000) with points title 'Old' "
