...
CMD_F1="$LABEL 'Proposed vs Actual starting times for intervals of Input node#${array[1]} in ${array[0]} [$INPUT_COUNT INs, $COMPUTE_COUNT CNs, $INPUT_BW GB/s] [$DATE]'; plot "
