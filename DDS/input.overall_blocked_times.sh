...
CMD_F1="$LABEL 'Overall blocked duration of IB, CB, and scheduler of Input node#${array[1]} in ${array[0]} (running time = $RUNNING_TIME s) [$INPUT_COUNT INs, $COMPUTE_COUNT CNs, $INPUT_BW GB/s] [$DATE]'; plot "
